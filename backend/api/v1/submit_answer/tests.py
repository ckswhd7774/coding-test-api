...
class SubmitAnswerListAPITest(APITestCase):
    """
    - 성공 상태 코드 테스트
    - 페이지네이션 응답 필드 테스트
    - 페이지네이션 사이즈 테스트
...
class SubmitAnswerCreateAPITest(APITestCase):
    """
    - 성공 상태 코드 테스트
    - 성공 응답 필드 테스트
    - 생성된 데이터 테스트
...
class SubmitAnswerRetrieveAPITest(APITestCase):
    """
    - 성공 상태 코드 테스트
    - 성공 응답 테스트
    """
...
class SubmitAnswerUpdateAPITest(APITestCase):
    """
    - 성공 상태 코드 테스트
    - 성공 응답 테스트
    - 수정된 데이터 테스트
...
class SubmitAnswerDestroyAPITest(APITestCase):
    """
    - 성공 상태 코드 테스트
    - 삭제된 데이터 테스트
    """
