...
class ExplantaionListAPITest(APITestCase):
    """
    - 성공 상태 코드 테스트
    - 페이지네이션 응답 필드 테스트
    - 페이지네이션 사이즈 테스트
...
class ExplantaionCreateAPITest(APITestCase):
    """
    - 성공 상태 코드 테스트
    - 성공 응답 필드 테스트
    - 생성된 데이터 테스트
...
class ExplantaionRetrieveAPITest(APITestCase):
    """
    - 성공 상태 코드 테스트
    - 성공 응답 테스트
    """
...
class ExplantaionUpdateAPITest(APITestCase):
    """
    - 성공 상태 코드 테스트
    - 성공 응답 테스트
    - 수정된 데이터 테스트
...
class ExplantaionDestroyAPITest(APITestCase):
    """
    - 성공 상태 코드 테스트
    - 삭제된 데이터 테스트
    """
